...
var STOP_PROCESSING = new Error('____stopProcessing____')
...
module.exports = function (opts) {
  ...
  var continueProcessingOnError = opts.continueProcessingOnError
  ...
  function prioritizeRecords (records) {
    ...
    // (Should only be one...)
    var isFailed = R.propEq('status', STATUS_CODES.failed)
    var firstFailed = R.find(isFailed, records)
